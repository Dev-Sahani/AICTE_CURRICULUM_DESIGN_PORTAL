...
export default function AddUserModal({onClose}){
    ...
    <div className="overflow-y-auto bg-[#3c3c5066] overflow-x-hidden fixed top-0 left-0 z-50 w-full md:inset-0 h-full max-h-full">
        <div className="relative flex items-center justify-center h-full w-full">
            {/* Modal content */} 
            <div className="h-[35rem] w-[34rem] relative rounded-lg shadow bg-primary-50">
                {/* Modal header */}
                <div className="flex items-center justify-between p-2 border-b rounded-t">
                    ...
                    <button onClick={()=>onClose()} className="bg-secondary-400 rounded-full w-8 h-8 text-2xl font-semibold">
                        x
                    </button>
                </div>
                {/* Modal body */}
