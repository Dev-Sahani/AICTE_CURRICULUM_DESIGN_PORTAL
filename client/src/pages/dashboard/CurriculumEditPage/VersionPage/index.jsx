...
export default function VersionPage(){
    ...
    <div className="">
        ...
        <div className="flex flex-col m-4 gap-4">
            {
                loading?
                <Loading count={8} cardClassName="w-full h-16" containerClassName="rounded" />
                :
                data?.map((version,ind)=>(
                    <div key={ind} className="w-full rounded flex justify-between items-center p-4 border-2 border-gray-500">
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <button className="py-1.5 px-3 text-white bg-primary-500 rounded" onClick={()=>{setVersion(version?.version); setShowConfirmModal(true)}} disabled={loading}>
                                Apply
                            </button>
                        </div>
                    </div> 
