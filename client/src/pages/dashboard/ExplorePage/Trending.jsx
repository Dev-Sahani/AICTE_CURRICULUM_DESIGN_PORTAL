  ...
  return (
    <div>
      <div className="flex flex-row gap-1">
        <div className="text-[25px] font-semibold text-[#008AD4] font-sans">
          Trending
        </div>
        <div className="flex justify-center items-center">
          <img src={Fire} className="w-8 h-8" alt="fire image" />
        </div>
      </div>
          ...
          return (
            <Link to="error">
              <div className=" flex flex-row px-3  bg-white rounded-lg items-center justify-between">
                <div className="text-[#064D74] text-xl-custom font-medium h-full">
                  #{x}
                </div>
                <div>
                  <img
