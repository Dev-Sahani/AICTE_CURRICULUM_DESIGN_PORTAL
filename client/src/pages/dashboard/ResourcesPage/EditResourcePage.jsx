  ...
  return (
    <Modal onClose={onClose}>
      <form className="mt-4 w-full p-4 pt-8 flex flex-col gap-2 overflow-auto">
        ...
        <div className="flex justify-between items-center px-2">
          <label className="" for="author@add">
            Author
          </label>
          <input
            value={state.author}
        ...
        <div className="flex justify-between items-center px-2">
          <label className="" for="publisher@add">
            Publisher
          </label>
          <input
        ...
        <div className="flex justify-between items-center px-2">
          <label className="" for="imgurl@add">
            Image Url
          </label>
          <input
        ...
        <div className="flex justify-start gap-12 items-center px-2">
          <label className="" for="type@invite">
            Format
          </label>
          <select
        ...
        <div className="items-center px-2">
          <label className="block" for="text@invite">
            Description
          </label>
          <textarea
            type="text"
    ...
    <div className="overflow-y-auto bg-[#3c3c5066] overflow-x-hidden fixed top-0 left-0 z-50 w-full md:inset-0 h-full max-h-full">
      <div className="relative flex items-center justify-center h-full w-full">
        ...
        <div className="h-[36rem] w-[34rem] relative rounded-lg shadow bg-primary-50">
          <button
            onClick={() => onClose()}
            className="bg-secondary-400 rounded-full w-8 h-8 text-2xl-custom font-semibold absolute top-[4px] right-[4px]"
          >
            x
          </button>
