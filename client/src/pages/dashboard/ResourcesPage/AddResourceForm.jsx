...
export default function AddResourceForm({onClose}) {
    ...
    const handleAdd = async (e)=>{
        setLoading(true)
        try{
            if(!state.type || state.type=="Sel" || !state.author || !state.title || !state.url || !state.coverImageUrl || !state.description){
    ...
    return <div className="overflow-y-auto bg-[#3c3c5066] overflow-x-hidden fixed top-0 left-0 z-50 w-full md:inset-0 h-full max-h-full">
