...
function Template3(){          
    ...
    <div className='flex flex-row justify-between '>
       ...
       <div className='gap-2 px-2 flex flex-row border border-[#989898] rounded-[6px] h-[48px] w-[440px] shrink-0 shadow-md flex-start items-center bg-white'>
        <div><img src={Search} alt="" className="w-[48px] h-[48px]"/></div>
        <div className='text-[#989898] text-[16px]'>
               <form className=' w-[368px]  h-[40px]'>
