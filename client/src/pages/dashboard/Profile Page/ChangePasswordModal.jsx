...
export default function ChangePasswordModal({ onClose }) {
  ...
  const inputContainerClass =
    "flex justify-between items-center text-lg-custom w-full h-12 m-2 px-2 border-[1.4px] border-gray-500 outline-none rounded bg-white";
      ...
      >
        <div className={inputContainerClass}>
          ...
          <button
            type="button"
            onClick={() =>
              setShowPass([!showPass[0], showPass[1], showPass[2]])
            }
          >
            <img
              className="w-6 h-6"
              src={showPass[0] ? showPassword : hidePassword}
              alt="password"
            />
          </button>
        </div>
        <div className={inputContainerClass}>
          ...
          >
            <img
              className="w-6 h-6"
              src={showPass[1] ? showPassword : hidePassword}
              alt="password"
            />
          </button>
        </div>
        <div className={inputContainerClass}>
          ...
          >
            <img
              className="w-6 h-6"
              src={showPass[2] ? showPassword : hidePassword}
              alt="password"
            />
          </button>
        </div>
